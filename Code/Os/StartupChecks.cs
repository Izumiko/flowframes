...
namespace Flowframes.Os
{
    class StartupChecks
    {
        static bool IsWin10Or11()
        {
            ...
            return version.Contains("windows 10", StringComparison.OrdinalIgnoreCase) || version.Contains("windows 11", StringComparison.OrdinalIgnoreCase);
        }
        ...
        {
            if (!File.Exists(Paths.GetVerPath()) && Paths.GetExeDir().Contains("temp", StringComparison.OrdinalIgnoreCase))
            {
            ...
            if (!version.Contains("windows 10", StringComparison.OrdinalIgnoreCase) && !version.Contains("windows 11", StringComparison.OrdinalIgnoreCase) && !Config.GetBool("ignoreIncompatibleOs", false))
            {
